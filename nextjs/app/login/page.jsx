...
function RegisterForm() {
  ...
  return (
    ...
    <div className="rounded-lg bg-white p-4 font-bold shadow-md">
        <>
          <h1 className="p-1 text-center text-xl text-black mb-2 font-bold">Sign In with Social Media</h1>
      ...
      <div className="already mt-3 text-center text-black">
        Not a member yet?{" "}
