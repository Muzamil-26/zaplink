...
function RegisterForm() {
  ...
  return (
    <div className="main-signup flex min-h-screen w-full flex-col items-center justify-center gap-3 p-4">
      <div className="w-full max-w-lg rounded-lg bg-white p-4 text-[#000000!important] shadow-md">
